...
int main()
{
    ...
    while(1)
    {
        cout<<"1(InsertFirst)  2.(InsertLast)  3.(InsertAfter)  4.(DeleteFirst)  "<<endl;
		cout<<"5.(DeleteLast)  6(SearchItem)  7.(PrintList)  8.(ReversePrint)  "<<endl;
        cout<<"9.(DeleteItem) 10.(Left Rotate)  11.(Right Rotate)  12.(Exit)  "<<endl;
        cin>>choice;
        if(choice==1)
        {
            int element;
